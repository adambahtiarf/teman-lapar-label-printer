...
import { getAttributesClient } from "@/lib/client-data"
import { ORDER_CODE_PREFIX_INFO } from "@/lib/platforms"

export function SettingsPageClient() {
  const queryFn = useCallback(() => getAttributesClient(false), [])
  const { data: attributes, error, isLoading, reload } = useClientQuery({
    queryFn,
    subscribeTo: ["attributes", "attribute_options"],
  })
  ...
  return (
    <AppShell>
      ...
      {!isLoading && !error && attributes?.length ? (
